...
public class AmbientFigure2 {
    ...
    public AmbientFigure2(Graphics graphics, boolean[][] gArray, int size) {
        this.gArray = gArray;
    ...
    public Vector flyFigureSerch(boolean[][] fga) {
        ...
        while (vHabPoints.size() > 0 && iEnter != -1 && jEnter != -1) {
            ...
            if (((HabPoint) vHabPoints.get(0)).goDown == true) {
                for (int i = 0; i < findingFigure.size(); i++) { //Проверяю есть ли такая точка в фигуре
                    if (((HabPoint) findingFigure.get(i)).line == ((HabPoint) vHabPoints.get(0)).line + 1 && ((HabPoint) findingFigure.get(i)).column == ((HabPoint) vHabPoints.get(0)).column) {
                        ((HabPoint) vHabPoints.get(0)).goDown = false; //Если уже есть, то добавлять её не надо
                    }
                }

                if (((HabPoint) vHabPoints.get(0)).goDown == true) {
                    for (int i = 0; i < vHabPoints.size(); i++) {
                        if (((HabPoint) vHabPoints.get(i)).line == ((HabPoint) vHabPoints.get(i)).line && ((HabPoint) vHabPoints.get(i)).column == ((HabPoint) vHabPoints.get(i)).column) {
                            ((HabPoint) vHabPoints.get(0)).goDown = false; //Если уже есть, то добавлять её не надо
                        }
                    }
                }
            ...
            if (((HabPoint) vHabPoints.get(0)).goLeft == true) {
                for (int i = 0; i < findingFigure.size(); i++) { //Проверяю есть ли такая точка в фигуре
                    if (((HabPoint) findingFigure.get(i)).line == ((HabPoint) vHabPoints.get(0)).line && ((HabPoint) findingFigure.get(i)).column == ((HabPoint) vHabPoints.get(0)).column - 1) {
            ...
            if (((HabPoint) vHabPoints.get(0)).goUp == true) { //Новая точка лежит выше текущей
                for (int i = 1; i < findingFigure.size(); i++) { //Проверяю есть ли такая точка в фигуре
                    if (((HabPoint) findingFigure.get(i)).line == ((HabPoint) vHabPoints.get(0)).line - 1 && ((HabPoint) findingFigure.get(i)).column == ((HabPoint) vHabPoints.get(0)).column) {
                ...
                if (((HabPoint) vHabPoints.get(0)).goUp == true) {
                    for (int i = 1; i < vHabPoints.size(); i++) {
                        if (((HabPoint) vHabPoints.get(i)).line == ((HabPoint) vHabPoints.get(i)).line && ((HabPoint) vHabPoints.get(i)).column == ((HabPoint) vHabPoints.get(i)).column) {
                            ((HabPoint) vHabPoints.get(0)).goUp = false; //Если уже есть, то добавлять её не надо
                        }
                    }
        ...
        if (((HabPoint) findingFigure.get(i)).line == ((HabPoint) findingFigure.get(ii)).line && ((HabPoint) findingFigure.get(i)).column == ((HabPoint) findingFigure.get(ii)).column && i != ii) {
