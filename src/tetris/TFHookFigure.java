 ...
 * @author Luke
 */
public class TFHookFigure extends TetrisFigure {

    //boolean[][] gameAr;
    int position;

    public TFHookFigure(Graphics graphics, Color paintColor, int size, boolean[][] gameAr) {
        ...
        if (position == 1) { //1
            unitsArray[0] = new Unit(this.graphics, 6 * size, -2 * size, size, this.paintColor, gameAr);
